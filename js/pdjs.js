// Original file Generated by CoffeeScript 1.7.1
// Edited in fork for multi-environment compatiblity
...
(function (definition) {
    ...
    // Common/Node/RequireJS, the module exports the PDJSobj constructor and when
    // executed as a simple <script>, it creates a PDJSobj global instead.
    ...
    // <script>
        ...
        // Get the `window` object, save the previous PDJSobj global
        // and initialize PDJSobj as a global.
        var previousPDJSobj = global.PDJSobj;
        global.PDJSobj = definition();

        // Add a noConflict function so Q can be removed from the
        // global namespace.
        global.PDJSobj.noConflict = function () {
            global.PDJSobj = previousPDJSobj;
            return this;
        };

    } else {
        throw new Error("Can't export constructor; this environment was not anticipated by Node PDJS.");
    }

})(function() {
    "use strict";
    
    //we need an ajax method
    var ajaxMethod = function () {};
    //if we have jQuery.ajax
    if (typeof jQuery != "undefined" && typeof jQuery.ajax == "function") {
        //then use it
        ajaxMethod = jQuery.ajax.bind(jQuery);
    }
    //if there is a require function available, we can try using najax
    else if (typeof require == "function") {
        ajaxMethod = require("najax");
    }
    else {
        throw new Error("Can't find ajax method; this environment was not anticipated by Node PDJS.");
    }
